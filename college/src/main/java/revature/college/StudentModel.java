...
public class StudentModel {
	...
	public String favColor;
	 ...
	 //this is a constructor that maps the database values
	//to the variables in our code
	
	public StudentModel(int id, String firstName, 
			String lastName, int age, Date birthday, String
			fav_color) {
	...
	public String toString() {
		return "StudentModel [id=" + id + ", firstName=" 
